...
func sortedHillClimbing(collectionToDivide: [Int]) {
	let maxIndex = collectionToDivide.count-1
	var firstBasketIndexes: [Int] = []
	var secondBasketIndexes: [Int] = []
	let collectionToDivide = collectionToDivide.sorted { $0 > $1 }
...
sortedHillClimbing(collectionToDivide: [7,9,7,6,7,7,5,7,5,6])
